Storēn<section class="py-24 bg-white">
  <div class="container-custom">
    <div class="text-center mb-16">
        <p class="text-[10px] font-bold tracking-[0.2em] text-gray-400 uppercase mb-4">7,000+ small businesses trust Allo</p>
        <h2 class="text-4xl md:text-5xl font-bold text-gray-900 tracking-tight">Built for people like you</h2>
    </div>
